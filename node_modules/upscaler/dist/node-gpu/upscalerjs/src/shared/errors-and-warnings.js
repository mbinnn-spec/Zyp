...
exports.ERROR_UNDEFINED_MODEL = new Error('An undefined model was provided to UpscalerJS');
...
var ERROR_MODEL_DEFINITION_BUG = function (err) { return new Error("There is a bug with the upscaler code. Please report this. ".concat(err ? "Error: ".concat(err) : '').trim()); };
exports.ERROR_MODEL_DEFINITION_BUG = ERROR_MODEL_DEFINITION_BUG;
