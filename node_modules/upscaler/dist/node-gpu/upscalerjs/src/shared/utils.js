...
exports.checkModelDefinition = exports.processAndDisposeOfTensor = exports.nonNullable = exports.wrapGenerator = exports.isAborted = exports.isMultiArgTensorProgress = exports.isSingleArgProgress = exports.isProgress = exports.warn = void 0;
...
function processAndDisposeOfTensor(tf, tensor) {
    var _processFns = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        _processFns[_i - 2] = arguments[_i];
    }
    var processFns = _processFns.filter(nonNullable);
    if (processFns.length) {
        var processedTensor = tf.tidy(function () { return processFns.reduce(function (reducedTensor, processFn) { return processFn(reducedTensor); }, tensor); });
...
var checkModelDefinition = function (modelDefinition) {
    var _a, _b;
    if (modelDefinition === undefined) {
        throw errors_and_warnings_1.ERROR_UNDEFINED_MODEL;
    }
    if (!(0, constants_1.isValidModelType)((_a = modelDefinition.modelType) !== null && _a !== void 0 ? _a : 'layers')) {
        throw (0, errors_and_warnings_1.ERROR_INVALID_MODEL_TYPE)(modelDefinition);
    }
    if (!modelDefinition.path && !((_b = modelDefinition._internals) === null || _b === void 0 ? void 0 : _b.path)) {
        throw (0, errors_and_warnings_1.GET_MODEL_CONFIGURATION_MISSING_PATH_AND_INTERNALS)(modelDefinition);
    }
};
exports.checkModelDefinition = checkModelDefinition;
